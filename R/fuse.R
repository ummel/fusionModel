#' Fuse variables to a recipient dataset using conditional distribution matching
#'
#' @description
...
#' @param k Integer. Number of nearest neighbors to select from donor observations.
...
fuse <- function(data,
  ...
  for (i in 1:length(pfixes)) {
    ...
    # Simulate values for case of single continuous variable
    ...
    if (block | meta$ytype[[v[1]]] == "continuous") {
      ...
      nn <- RANN::nn2(data = dpred, query = pred, k = k)
